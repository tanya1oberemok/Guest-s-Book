    ...
    <div class="container">
        ...
        <form action="{{ route('update-user', $user->id) }}" method="POST">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <input name="name" type="text" class="form-control"  id="inputName3" value="{{ $user->name }}">
                </div>
            </div>
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <input name="password" type="text" class="form-control" id="inputPassl3" value="{{ $user->password }}">
                </div>
            </div>
